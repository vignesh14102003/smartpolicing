...
<head>
    ...
    <script>
        function dsttc(caseid, title, registered_date, AccustName, Station_id, case_details) {
            document.getElementById("data").innerHTML = '<h2>Case ID: ' + caseid.toString() + '</h2><br><br><p><<<<<<<<<<<<<<<< Case Details >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>><br><br>Title: ' + title + '<br><br>Registered Date: ' + registered_date+ '<br><br>Accust Name: ' + AccustName + '<br><br>Station ID: ' + Station_id + '<br><br>Case Details: ' + case_details+'<br><br><button onclick="edit()">Edit</button> ' ;
        }
        ...
        <div class="academies">
            ...
            ?>
                    ...
                    <div class="panel">
                        ...
                        ?>
                                <p class="faqAns" onclick="dsttc('<?php echo $row2['caseid']; ?>','<?php echo $row2['title']; ?>','<?php echo $row2['registered_date']; ?>','<?php echo $row2['AccustName']; ?>','<?php echo $row2['Station_id']; ?>','<?php echo $row2['case_details']; ?>')" id="c_id"><br><?php echo $row2['caseid'];  ?></p>
                        <?php
                            }
                        }
                        ?>
