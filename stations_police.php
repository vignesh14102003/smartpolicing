...
if ($result->num_rows > 0) {
    $index = 0; // To create unique IDs
    while ($row = $result->fetch_assoc()) {
        $index++;
        ?>
        
        <button class="accordion" id="accordion_<?php echo $index; ?>" value="<?php echo $row['Station_id']; ?>"><?php echo $row['Station_id']; ?></button>
        <div class="panel">
            <?php
